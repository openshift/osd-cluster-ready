...
require (
	...
	github.com/openshift/custom-domains-operator 252eec9b56b1 // indirect
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.61.0 // indirect
